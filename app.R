...
ingredients <- data.frame(
  ...
  custom_sentence = c(
    "885 Russell Blvd Davis, CA 95616\nTrader Joe's offers the cheapest prices on unsalted butter alongside Safeway but does not sell brown sugar, baking soda, or chopped walnuts - making it impossible to buy all ingredients needed at this store.",
